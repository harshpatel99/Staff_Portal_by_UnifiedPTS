 ...
 * Use the [TransferLetterFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TransferLetterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_transfer_letter, container, false)

        val webView = view.findViewById<WebView>(R.id.transferLetterWebView)
        val backButton = view.findViewById<ImageView>(R.id.transferLetterBackImageView)
    ...
    companion object {
         ...
         * @return A new instance of fragment TransferLetterFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TransferLetterFragment().apply {
